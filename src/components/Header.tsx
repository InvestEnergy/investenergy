			...
			<div className="h-[48px] flex justify-between items-center w-full max-w-[1240px] mx-auto">
				...
				<div className="items-center hidden gap-3 md:flex">
					...
					<ul className="flex items-center gap-8 h-[48px] px-8 bg-[#EEF6FC] dark:bg-[#444444] rounded-full">
						<li>
							<span className="font-bold cursor-pointer" onClick={() => openPdfInNewTab('/pdfs/ENGC.pdf')}>Whitepaper</span>
						</li>
						<li>
							<Link href="#">
								<Image
				...
				`}>
					<div className="flex items-center justify-between">
						<h4 className="font-prompt text-2xl font-medium leading-[24.19px]">Menu</h4>
						<svg onClick={() => setSidebarOpen(false)} className="text-[#323232] dark:text-white cursor-pointer" width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<ul className="flex flex-col divide-y-[2px] divide-[#F0F5FC] dark:divide-opacity-50 mt-12 ">
						...
						<li onClick={() => setSidebarOpen(false)} className="py-6">
							<span className="text-xl font-bold cursor-pointer" onClick={() => openPdfInNewTab('/pdfs/ENGC.pdf')}>Whitepaper</span>
						</li>
						<li onClick={() => setSidebarOpen(false)} className="py-6">
							<ThemeToggle />
						</li>
