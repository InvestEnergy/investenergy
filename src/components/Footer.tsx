      ...
      <div className="flex flex-col md:flex-row justify-between mx-auto max-w-7xl px-5">
        ...
        <div className="flex flex-col justify-between flex-1 md:items-end">
          ...
          <div className="flex items-center gap-4 mt-6 md:mt-0">
            <Link href="https://www.facebook.com/" target="_blank" className="bg-[#FAFAFA] hover:bg-greenish-500 hover:dark:bg-dark-200 flex justify-center items-center h-12 w-12 rounded-lg group">
              <svg width="24" height="24" className="text-greenish-500 group-hover:text-white dark:text-dark" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href="https://www.instagram.com/" target="_blank" className="bg-[#FAFAFA] hover:bg-greenish-500 hover:dark:bg-dark-200 flex justify-center items-center h-12 w-12 rounded-lg group">
              <svg className="text-greenish-500 group-hover:text-white dark:text-dark" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href="https://twitter.com/" target="_blank" className="bg-[#FAFAFA] hover:bg-greenish-500 hover:dark:bg-dark-200 flex justify-center items-center h-12 w-12 rounded-lg group">
              <svg className="text-greenish-500 group-hover:text-white dark:text-dark" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href="https://t.me/" target="_blank" className="bg-[#FAFAFA] hover:bg-greenish-500 hover:dark:bg-dark-200 flex justify-center items-center h-12 w-12 rounded-lg group">
              <svg className="text-greenish-500 group-hover:text-white dark:text-dark" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
